...
def get_channel(self, name: str) -> AudioChannel:
    """Get or register an audio channel"""
    if name not in self.channels:
        self.channels[name] = AudioChannel()
    return self.channels[name]


def mix(self, frames: Iterable[bytes | None]) -> bytes | None:
